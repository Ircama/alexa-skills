...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output = "Attendi l'attivazione dell'ultimo video della Santa Sede"
        channel_id = "UC7E-LYc1wivk33iyt5bR5zQ"
        ...
        with urllib.request.urlopen(youtube_url) as url:
            data = json.loads(url.read().decode())
            videoId = data['items'][0]['id']['videoId']
            yt = YouTube('https://www.youtube.com/watch?v=' + videoId)
            stream = yt.streams.first()
            directive = LaunchDirective(video_item=VideoItem(
                source=stream.url, metadata=Metadata(title=stream.title, subtitle=yt.description)))
        return (
